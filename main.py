...
class CampusNavigationApp:
    def __init__(self, root):
        ...
        self.create_canvas()
        self.canvas_update_interval = 100  # Update canvas every 100 milliseconds
    ...
    def create_input_panel(self):
        ...
        self.execute_button.grid(row=3, column=0, columnspan=2, pady=20, sticky="ew")  # Centered in the left panel side
...
#
#
# nx.draw(G, pos, with_labels=True, node_size=300, node_color="skyblue", font_size=5, font_weight="bold")
...
#
# #plt.axis('on')
# plt.imshow(image, extent=[0, image_width, 0, image_height], alpha=0.5)
#
# # Display the graph
# plt.show()
